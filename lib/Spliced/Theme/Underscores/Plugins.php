...
class Plugins {
	...
	// public static function filter_bisso_flexslider_class( array $classes ) {
	...
	// public static function filter_bisso_flexslider_caption_class( array $classes ) {
	// 	$classes[] = 'stack-foreground';
	// 	$classes[] = 'skin-dark-crystal';
	// 	return $classes;
	// }

	// public static function filter_bisso_flexslider_slide_class( array $classes ) {
	// 	$classes[] = 'stack';
	// 	$classes[] = 'slide';
	// 	return $classes;
	// }

	// public static function filter_bisso_flexslider_post_types( array $post_types ) {
	...
	// public static function filter_option_wpseo_titles ( array $value ) {
	 ...
	 * Yoast Breadcrumbs
	 */
	// public static function filter_wpseo_breadcrumb_links ( $links ) {
	// 	global $query;
	// 	return $links;
	// }
	...
	// public static function action_p2p_init() {
	...
	// public static function filter_p2p_new_post_args ( array $args, \P2P_Directed_Connection_Type $ctype, $from  ) {
	// 	global $cfs;
	// 	return $args;
	// }
	...
	// public static function filter_spliced_limit_attachments ( $post_type ) {
	// 	$limits = array(
	// 		self:://posttype => //limit,
	// 	);
	...
	// public static function filter_cfs_field_types( array $field_types ) {
